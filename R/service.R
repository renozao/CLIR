...
#' 
#' @importFrom pkgmaker packagePath topns_name
#' @export 
service_files <- function(name, all = FALSE, full.names = FALSE, package = topns_name()){
...
#' @export
render_service <- function(name, ..., args = NULL, work_dir = '.', save = FALSE, envir = parent.frame(), package = topns_name()){
